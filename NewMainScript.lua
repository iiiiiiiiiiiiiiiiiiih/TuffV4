...
local function downloadPremadeProfiles(commit)
	...
	local success, response = pcall(function()
		return game:HttpGet('https://api.github.com/repos/Kingifyfrmdao/kingp/contents/profiles/premade?ref=' .. commit)
	end)
...
if not shared.VapeDeveloper then
	local _, subbed = pcall(function()
		return game:HttpGet('https://github.com/Kingifyfrmdao/kingp')
	end)
	local commit = 'main'
	local ok, res = pcall(function()
		return game:HttpGet('https://api.github.com/repos/Kingifyfrmdao/kingp/commits/main', true)
	end)
	if ok and res then
